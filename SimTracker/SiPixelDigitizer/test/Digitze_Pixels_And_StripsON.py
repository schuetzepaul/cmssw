...
process.source = cms.Source("PoolSource", fileNames = cms.untracked.vstring(
    'file:/data/hazia/work/2Dtemplates/CMSSW_7_2_0_pre5/src/SimTracker/SiPixelDigitizer/test/ECDA73BA-2BFE-E311-9BE9-0025905A611E.root'
  )
)
...
process.myLocalDB = CalibTracker.Configuration.Common.PoolDBESSource_cfi.poolDBESSource.clone(
     ...
     #'sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERCALIB/Pixels/PixelDB2013/SiPixelQuality/SiPixelQuality_620p5/builder/deadModule_v20.db'
         'sqlite_file:/data/hazia/work/2Dtemplates/withsec/CMSSW_7_3_0_pre2/src/CondTools/SiPixel/test/siPixel2DTemplates38T_IOV5.db'
        #'frontier://FrontierProd/CMS_COND_PIXEL_000'
        ),
	toGet = cms.VPSet(cms.PSet(
                record = cms.string('SiPixel2DTemplateDBObjectRcd'),
                tag = cms.string('SiPixel2DTemplateDBObject38Tv3')
...
process.o1 = cms.OutputModule("PoolOutputModule",
      ...
      fileName = cms.untracked.string('file:digis_pixstrip_rwirrDB.root')
...
#process.simSiPixelDigis.digitizers.pixel.AddPixelInefficiencyFromPython = True
process.simSiPixelDigis.digitizers.pixel.LorentzAngle_DB = False
process.simSiPixelDigis.digitizers.pixel.UseTemplateAgeing = cms.bool(True)
process.simSiPixelDigis.digitizers.pixel.TemplateAgeingIrradiated = cms.bool(True)
process.simSiPixelDigis.digitizers.pixel.TanLorentzAnglePerTesla_BPix = cms.double(0.0459)
